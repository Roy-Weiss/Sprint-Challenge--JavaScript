...
zooAnimals.forEach(function(arr) {
    displayNames.push(`name: ${arr["animal_name"]}`)
    return displayNames
})
zooAnimals.forEach(function(arr) {
    displayNames.push(`Scientific: ${arr["scientific_name"]}`)
    return displayNames
})
...
zooAnimals.map(function(arr) {
    lowCaseAnimalNames.push(arr["animal_name"].toLowerCase())
...
zooAnimals.filter(function(arr) {
    if (arr["population"] < 5) {
        lowPopulationAnimals.push(arr["population"])
    }
